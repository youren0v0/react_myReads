...
class Home extends Component {
  render () {
    const { changeShow, ...props } = this.props
    return (
      <div className="list-books">
        <div className="list-books-title">
          <h1>MyReads</h1>
        </div>
        <BookList bookListContent={this.props.bookListContent} selectContent={this.props.selectContent} {...props}/>
        <SearchButton changeShow={(msg) => changeShow(msg)}/>
      </div>
    )
  }
}
